...
enum class AuthErrorCode : uint8_t
{
    ...
    /// Response was not expected or not received in time
    UNEXPECTED_RESPONSE = 0x2,
    ...
    UNKNOWN_USER = 0xB,
    /// The master on a different association has required session key status too often
