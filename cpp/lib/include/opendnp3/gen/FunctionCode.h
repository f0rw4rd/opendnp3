...
enum class FunctionCode : uint8_t
{
    ...
    WRITE = 0x2,
    /// Outstation shall select (or arm) the output points specified by the objects in the request in preparation for a
    ...
    IMMED_FREEZE_NR = 0x8,
    /// Outstation shall copy the point data values specified by the objects in the request into a separate freeze
    /// buffer and then clear the values
    FREEZE_CLEAR = 0x9,
    /// Same as FREEZE_CLEAR but outstation shall not send a response
    FREEZE_CLEAR_NR = 0xA,
    /// Outstation shall copy the point data values specified by the objects in the request to a separate freeze buffer
    /// at the time and/or time intervals specified in a special time data information object
    FREEZE_AT_TIME = 0xB,
    ...
    /// Outstation shall assign the events generated by the points specified by the objects in the request to one of the
    /// classes
    ASSIGN_CLASS = 0x16,
