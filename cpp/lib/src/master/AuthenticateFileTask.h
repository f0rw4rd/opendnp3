 ...
 */
#ifndef OPENDNP3_AUTHENTICATEFILETASK_H
#define OPENDNP3_AUTHENTICATEFILETASK_H
...
/**
 * Master task for AUTHENTICATE_FILE (FC=0x1D).
 * Sends Group70Var2 with username/password, expects Group70Var4 response
 * containing the auth key.
 */
class AuthenticateFileTask final : public IMasterTask
{
public:
    AuthenticateFileTask(const std::shared_ptr<TaskContext>& context,
