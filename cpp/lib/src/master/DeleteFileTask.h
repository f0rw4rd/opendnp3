 ...
 */
#ifndef OPENDNP3_DELETEFILETASK_H
#define OPENDNP3_DELETEFILETASK_H
...
/**
 * Master task for DELETE_FILE (FC=0x1B).
 * Sends Group70Var8 (filename), expects a response (typically empty or Group70Var4).
 */
class DeleteFileTask final : public IMasterTask
{
public:
    DeleteFileTask(const std::shared_ptr<TaskContext>& context,
