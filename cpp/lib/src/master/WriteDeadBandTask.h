 ...
 */
#ifndef OPENDNP3_WRITEDEADBANDTASK_H
#define OPENDNP3_WRITEDEADBANDTASK_H
...
/**
 * Master task for writing analog input dead-bands (Group 34).
 * Sends a WRITE request with Group34Var3 (float) objects.
 */
class WriteDeadBandTask final : public IMasterTask
{
public:
    WriteDeadBandTask(const std::shared_ptr<TaskContext>& context,
