 ...
 */
#ifndef OPENDNP3_NO_RESPONSE_TASK_H
#define OPENDNP3_NO_RESPONSE_TASK_H
...
/**
 * A task for function codes where the outstation does not send a response
 * (e.g. DIRECT_OPERATE_NR, IMMED_FREEZE_NR, FREEZE_CLEAR_NR).
 *
 * The task completes immediately after the request is transmitted.
 */
class NoResponseTask final : public IMasterTask
{

public:
    NoResponseTask(const std::shared_ptr<TaskContext>& context,
