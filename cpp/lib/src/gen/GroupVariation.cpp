...
GroupVariation GroupVariationSpec::from_type(uint16_t arg)
{
    ...
    {
    case (0x00FE):
        return GroupVariation::Group0Var254;
    case (0x00FF):
        return GroupVariation::Group0Var255;
    case (0x100):
    ...
    case (0xC02):
        return GroupVariation::Group12Var2;
    case (0xC03):
        return GroupVariation::Group12Var3;
    case (0xD00):
    ...
    case (0x1503):
        return GroupVariation::Group21Var3;
    case (0x1504):
        return GroupVariation::Group21Var4;
    case (0x1505):
        return GroupVariation::Group21Var5;
    case (0x1506):
        return GroupVariation::Group21Var6;
    case (0x1507):
        return GroupVariation::Group21Var7;
    case (0x1508):
        return GroupVariation::Group21Var8;
    case (0x1509):
        return GroupVariation::Group21Var9;
    case (0x150A):
        return GroupVariation::Group21Var10;
    case (0x150B):
        return GroupVariation::Group21Var11;
    case (0x150C):
        return GroupVariation::Group21Var12;
    case (0x1600):
    ...
    case (0x1703):
        return GroupVariation::Group23Var3;
    case (0x1704):
        return GroupVariation::Group23Var4;
    case (0x1705):
        return GroupVariation::Group23Var5;
    case (0x1706):
        return GroupVariation::Group23Var6;
    case (0x1707):
        return GroupVariation::Group23Var7;
    case (0x1708):
        return GroupVariation::Group23Var8;
    case (0x1E00):
    ...
    case (0x2200):
        return GroupVariation::Group34Var0;
    case (0x2201):
        return GroupVariation::Group34Var1;
    case (0x2202):
        return GroupVariation::Group34Var2;
    case (0x2203):
        return GroupVariation::Group34Var3;
    case (0x2800):
    ...
    case (0x3200):
        return GroupVariation::Group50Var0;
    case (0x3201):
    ...
    case (0x5501):
        return GroupVariation::Group85Var1;
    case (0x5600):
        return GroupVariation::Group86Var0;
    case (0x5601):
        return GroupVariation::Group86Var1;
    case (0x5602):
        return GroupVariation::Group86Var2;
    case (0x5603):
        return GroupVariation::Group86Var3;
    case (0x5701):
        return GroupVariation::Group87Var1;
    case (0x5801):
        return GroupVariation::Group88Var1;
    case (0x6600):
        return GroupVariation::Group102Var0;
    case (0x6601):
        return GroupVariation::Group102Var1;
    case (0x6E00):
...
char const* GroupVariationSpec::to_string(GroupVariation arg)
{
    ...
    case (GroupVariation::Group0Var0):
        return "Group0Var0";
    case (GroupVariation::Group0Var254):
        return "Group0Var254";
    case (GroupVariation::Group0Var255):
        return "Group0Var255";
    ...
    case (GroupVariation::Group12Var1):
        return "Group12Var1";
    case (GroupVariation::Group12Var2):
        return "Group12Var2";
    case (GroupVariation::Group12Var3):
        return "Group12Var3";
    ...
    case (GroupVariation::Group20Var2):
        return "Group20Var2";
    case (GroupVariation::Group20Var3):
        return "Group20Var3";
    case (GroupVariation::Group20Var4):
        return "Group20Var4";
    case (GroupVariation::Group20Var5):
        return "Group20Var5";
    case (GroupVariation::Group20Var6):
        return "Group20Var6";
    case (GroupVariation::Group20Var7):
        return "Group20Var7";
    case (GroupVariation::Group20Var8):
        return "Group20Var8";
    ...
    case (GroupVariation::Group21Var2):
        return "Group21Var2";
    case (GroupVariation::Group21Var3):
        return "Group21Var3";
    case (GroupVariation::Group21Var4):
        return "Group21Var4";
    case (GroupVariation::Group21Var5):
        return "Group21Var5";
    case (GroupVariation::Group21Var6):
        return "Group21Var6";
    case (GroupVariation::Group21Var7):
        return "Group21Var7";
    case (GroupVariation::Group21Var8):
        return "Group21Var8";
    case (GroupVariation::Group21Var9):
        return "Group21Var9";
    case (GroupVariation::Group21Var10):
        return "Group21Var10";
    case (GroupVariation::Group21Var11):
        return "Group21Var11";
    case (GroupVariation::Group21Var12):
        return "Group21Var12";
    ...
    case (GroupVariation::Group33Var8):
        return "Group33Var8";
    case (GroupVariation::Group34Var0):
        return "Group34Var0";
    ...
    case (GroupVariation::Group43Var8):
        return "Group43Var8";
    case (GroupVariation::Group50Var0):
        return "Group50Var0";
    case (GroupVariation::Group50Var1):
        return "Group50Var1";
    case (GroupVariation::Group50Var2):
        return "Group50Var2";
    ...
    case (GroupVariation::Group80Var1):
        return "Group80Var1";
    case (GroupVariation::Group85Var1):
        return "Group85Var1";
    case (GroupVariation::Group86Var0):
        return "Group86Var0";
    case (GroupVariation::Group86Var1):
        return "Group86Var1";
    case (GroupVariation::Group86Var2):
        return "Group86Var2";
    case (GroupVariation::Group86Var3):
        return "Group86Var3";
    case (GroupVariation::Group87Var1):
        return "Group87Var1";
    case (GroupVariation::Group88Var1):
        return "Group88Var1";
    case (GroupVariation::Group102Var0):
        return "Group102Var0";
    case (GroupVariation::Group102Var1):
        return "Group102Var1";
...
char const* GroupVariationSpec::to_human_string(GroupVariation arg)
{
    ...
    {
    case (GroupVariation::Group0Var0):
        return "Device Attributes - Any Variation";
    case (GroupVariation::Group0Var254):
        return "Device Attributes - Non-specific All Attributes Request";
    case (GroupVariation::Group0Var255):
        return "Device Attributes - List of Attribute Variations";
    case (GroupVariation::Group1Var0):
    ...
    case (GroupVariation::Group12Var2):
        return "Binary Command - Pattern Control Block";
    case (GroupVariation::Group12Var3):
        return "Binary Command - Pattern Mask";
    case (GroupVariation::Group13Var0):
    ...
    case (GroupVariation::Group20Var3):
        return "Delta Counter - 32-bit With Flag";
    case (GroupVariation::Group20Var4):
        return "Delta Counter - 16-bit With Flag";
    case (GroupVariation::Group20Var5):
        return "Counter - 32-bit Without Flag";
    case (GroupVariation::Group20Var6):
        return "Counter - 16-bit Without Flag";
    case (GroupVariation::Group20Var7):
        return "Delta Counter - 32-bit Without Flag";
    case (GroupVariation::Group20Var8):
        return "Delta Counter - 16-bit Without Flag";
    case (GroupVariation::Group21Var0):
    ...
    case (GroupVariation::Group21Var3):
        return "Frozen Delta Counter - 32-bit With Flag";
    case (GroupVariation::Group21Var4):
        return "Frozen Delta Counter - 16-bit With Flag";
    case (GroupVariation::Group21Var5):
        return "Frozen Counter - 32-bit With Flag and Time";
    case (GroupVariation::Group21Var6):
        return "Frozen Counter - 16-bit With Flag and Time";
    case (GroupVariation::Group21Var7):
        return "Frozen Delta Counter - 32-bit With Flag and Time";
    case (GroupVariation::Group21Var8):
        return "Frozen Delta Counter - 16-bit With Flag and Time";
    case (GroupVariation::Group21Var9):
        return "Frozen Counter - 32-bit Without Flag";
    case (GroupVariation::Group21Var10):
        return "Frozen Counter - 16-bit Without Flag";
    case (GroupVariation::Group21Var11):
        return "Frozen Delta Counter - 32-bit Without Flag";
    case (GroupVariation::Group21Var12):
        return "Frozen Delta Counter - 16-bit Without Flag";
    case (GroupVariation::Group22Var0):
    ...
    case (GroupVariation::Group22Var3):
        return "Delta Counter Event - 32-bit With Flag";
    case (GroupVariation::Group22Var4):
        return "Delta Counter Event - 16-bit With Flag";
    case (GroupVariation::Group22Var5):
        return "Counter Event - 32-bit With Flag and Time";
    case (GroupVariation::Group22Var6):
        return "Counter Event - 16-bit With Flag and Time";
    case (GroupVariation::Group22Var7):
        return "Delta Counter Event - 32-bit With Flag and Time";
    case (GroupVariation::Group22Var8):
        return "Delta Counter Event - 16-bit With Flag and Time";
    case (GroupVariation::Group23Var0):
    ...
    case (GroupVariation::Group23Var3):
        return "Frozen Delta Counter Event - 32-bit With Flag";
    case (GroupVariation::Group23Var4):
        return "Frozen Delta Counter Event - 16-bit With Flag";
    case (GroupVariation::Group23Var5):
        return "Frozen Counter Event - 32-bit With Flag and Time";
    case (GroupVariation::Group23Var6):
        return "Frozen Counter Event - 16-bit With Flag and Time";
    case (GroupVariation::Group23Var7):
        return "Frozen Delta Counter Event - 32-bit With Flag and Time";
    case (GroupVariation::Group23Var8):
        return "Frozen Delta Counter Event - 16-bit With Flag and Time";
    case (GroupVariation::Group30Var0):
    ...
    case (GroupVariation::Group34Var0):
        return "Analog Input Dead-band - Any Variation";
    case (GroupVariation::Group34Var1):
        return "Analog Input Dead-band - 16-bit";
    case (GroupVariation::Group34Var2):
        return "Analog Input Dead-band - 32-bit";
    case (GroupVariation::Group34Var3):
        return "Analog Input Dead-band - Single-precision";
    case (GroupVariation::Group40Var0):
    ...
    case (GroupVariation::Group43Var0):
        return "Analog Command Event - Any Variation";
    case (GroupVariation::Group43Var1):
    ...
    case (GroupVariation::Group50Var0):
        return "Time and Date - Default Variation";
    case (GroupVariation::Group50Var1):
        return "Time and Date - Absolute Time";
    case (GroupVariation::Group50Var2):
        return "Time and Date - Absolute Time and Interval";
    case (GroupVariation::Group50Var3):
    ...
    case (GroupVariation::Group85Var1):
        return "Data Set Prototype - With UUID";
    case (GroupVariation::Group86Var0):
        return "Data Set Descriptor - Any Variation";
    case (GroupVariation::Group86Var1):
        return "Data Set Descriptor - Contents";
    case (GroupVariation::Group86Var2):
        return "Data Set Descriptor - Characteristics";
    case (GroupVariation::Group86Var3):
        return "Data Set Descriptor - Point Index Attributes";
    case (GroupVariation::Group87Var1):
        return "Data Set Present Value";
    case (GroupVariation::Group88Var1):
        return "Data Set Snapshot - Event";
    case (GroupVariation::Group102Var0):
        return "Unsigned Integer Without Flag - Any Variation";
    case (GroupVariation::Group102Var1):
        return "Unsigned Integer Without Flag - 8-bit";
    case (GroupVariation::Group110Var0):
...
{
    if (arg == "Group0Var0")
        return GroupVariation::Group0Var0;
    if (arg == "Group0Var254")
        return GroupVariation::Group0Var254;
    if (arg == "Group0Var255")
        return GroupVariation::Group0Var255;
    ...
    if (arg == "Group120Var9")
        return GroupVariation::Group120Var9;
    if (arg == "Group120Var10")
        return GroupVariation::Group120Var10;
    if (arg == "Group120Var11")
        return GroupVariation::Group120Var11;
    if (arg == "Group120Var12")
        return GroupVariation::Group120Var12;
    if (arg == "Group120Var13")
        return GroupVariation::Group120Var13;
    if (arg == "Group120Var14")
        return GroupVariation::Group120Var14;
    if (arg == "Group120Var15")
        return GroupVariation::Group120Var15;
    if (arg == "Group121Var0")
        return GroupVariation::Group121Var0;
    if (arg == "Group121Var1")
