...
Group50Var2::Group50Var2() : time(0), interval(0) {}

bool Group50Var2::Read(rseq_t& buffer, Group50Var2& output)
{
    return LittleEndian::read(buffer, output.time, output.interval);
}

bool Group50Var2::Write(const Group50Var2& arg, ser4cpp::wseq_t& buffer)
{
    return LittleEndian::write(buffer, arg.time, arg.interval);
}
