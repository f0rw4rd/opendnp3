...
Group120Var2::Group120Var2(uint32_t challengeSeqNum_, uint16_t userNum_, const ser4cpp::rseq_t& hmacValue_)
...
bool Group120Var5::Write(ser4cpp::wseq_t& buffer) const
{
    ...
    LittleEndian::write(buffer, this->keyChangeSeqNum, this->userNum, this->keyWrapAlgo, this->keyStatus,
                        this->hmacAlgo);
...
Group120Var6::Group120Var6(uint32_t keyChangeSeqNum_, uint16_t userNum_, const ser4cpp::rseq_t& keyWrapData_)
...
Group120Var9::Group120Var9(const ser4cpp::rseq_t& hmacValue_) : hmacValue(hmacValue_) {}
...
bool Group120Var10::Read(const rseq_t& buffer)
{
    ...
    LittleEndian::read(copy, this->keyChangeMethod, this->userOperation, this->statusChangeSeqNum, this->userRole,
                       this->userRoleExpDays);
...
bool Group120Var10::Write(ser4cpp::wseq_t& buffer) const
{
    ...
    LittleEndian::write(buffer, this->keyChangeMethod, this->userOperation, this->statusChangeSeqNum, this->userRole,
                        this->userRoleExpDays);
...
Group120Var12::Group120Var12(uint32_t keyChangeSeqNum_, uint16_t userNum_, const ser4cpp::rseq_t& challengeData_)
...
Group120Var13::Group120Var13(uint32_t keyChangeSeqNum_, uint16_t userNum_, const ser4cpp::rseq_t& encryptedUpdateKey_)
...
Group120Var14::Group120Var14(const ser4cpp::rseq_t& digitalSignature_) : digitalSignature(digitalSignature_) {}
...
Group120Var15::Group120Var15() : keyChangeSeqNum(0), userNum(0) {}

Group120Var15::Group120Var15(uint32_t keyChangeSeqNum_, uint16_t userNum_, const ser4cpp::rseq_t& hmacValue_)
    : keyChangeSeqNum(keyChangeSeqNum_), userNum(userNum_), hmacValue(hmacValue_)
{
}
...
{
    if (buffer.length() < Group120Var15::MIN_SIZE)
    {
        return false;
    }
