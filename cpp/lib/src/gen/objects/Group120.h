...
struct Group120Var2 : public IVariableLength
{
    ...
    Group120Var2(uint32_t challengeSeqNum, uint16_t userNum, const ser4cpp::rseq_t& hmacValue);
...
struct Group120Var6 : public IVariableLength
{
    ...
    Group120Var6(uint32_t keyChangeSeqNum, uint16_t userNum, const ser4cpp::rseq_t& keyWrapData);
...
struct Group120Var8 : public IVariableLength
{
    ...
    Group120Var8(KeyChangeMethod keyChangeMethod, CertificateType certificateType, const ser4cpp::rseq_t& certificate);
...
struct Group120Var9 : public IVariableLength
{
    ...
    explicit Group120Var9(const ser4cpp::rseq_t& hmacValue);
...
struct Group120Var12 : public IVariableLength
{
    ...
    Group120Var12(uint32_t keyChangeSeqNum, uint16_t userNum, const ser4cpp::rseq_t& challengeData);
...
struct Group120Var13 : public IVariableLength
{
    ...
    Group120Var13(uint32_t keyChangeSeqNum, uint16_t userNum, const ser4cpp::rseq_t& encryptedUpdateKey);
...
struct Group120Var14 : public IVariableLength
{
    ...
    explicit Group120Var14(const ser4cpp::rseq_t& digitalSignature);
...
struct Group120Var15 : public IVariableLength
{
    ...
    Group120Var15(uint32_t keyChangeSeqNum, uint16_t userNum, const ser4cpp::rseq_t& hmacValue);
