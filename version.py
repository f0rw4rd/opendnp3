...
Example: 3.1.2.1 (opendnp3 v3.1.2, first package revision)
"""
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        if sys.argv[1] == "--lib":
            ...
            print("Usage:")
            print("  python version.py          # Package version (3.1.2.1)")
            print("  python version.py --lib    # C++ library version (3.1.2)")
        else:
